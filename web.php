...
Route::get('/contacts/bulk-assignment-options', [\App\Http\Controllers\ContactController::class, 'bulkAssignmentOptions'])->name('contacts.bulkAssignmentOptions');
Route::post('/contacts/bulk',                  [\App\Http\Controllers\ContactController::class, 'bulk'])->name('contacts.bulk');
Route::get('/admin/contact-assignment-audit',   [\App\Http\Controllers\ContactController::class, 'assignmentAudit'])->name('admin.contactAssignmentAudit');
Route::get('/admin/contact-duplicates', [\App\Http\Controllers\ContactController::class, 'duplicateAudit'])->name('admin.contactDuplicates');
Route::post('/admin/contact-duplicates/merge', [\App\Http\Controllers\ContactController::class, 'duplicateMerge'])->name('admin.contactDuplicates.merge');
Route::post('/admin/contact-assignment-audit/reconcile', [\App\Http\Controllers\ContactController::class, 'reconcileAssignments'])->name('admin.contactAssignmentReconcile');
